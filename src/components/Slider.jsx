...
const Slider = () => {
  ...
  return (
    <div>
      ...
      <ChevronRight onClick={() => handleRightClick()} size={40} ref={elementRef} className="text-white cursor-pointer hidden md:block absolute mx-8 mt-[20rem] right-0" />

      <div className="flex w-full px-16 overflow-hidden" ref={elementRef}>
